...
// Inline eye icons to avoid external dependency
const EyeIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M12 5c-5 0-9 4-10 7 1 3 5 7 10 7s9-4 10-7c-1-3-5-7-10-7Zm0 12a5 5 0 1 1 0-10 5 5 0 0 1 0 10Zm0-2a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
  </svg>
);

const EyeSlashIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M3.28 2.22a.75.75 0 0 0-1.06 1.06l2.21 2.21C2.41 7 1 9.02 1 12c1 3 5 7 11 7 2.2 0 4.12-.6 5.73-1.55l3 3a.75.75 0 1 0 1.06-1.06L3.28 2.22Zm8.72 15.78c-5 0-9-4-10-7a10.7 10.7 0 0 1 3.02-3.67l2.22 2.18A5 5 0 0 0 12 17Zm8.98-5c-.37 1.12-1.12 2.33-2.18 3.46l-3.5-3.43A5 5 0 0 0 9.97 6.7L7.41 4.18C8.83 3.43 10.38 3 12 3c6 0 10 4 11 7-.23.7-.56 1.46-1.02 2Z" />
  </svg>
);
...
const mockUpdateProfile = async (_payload: FormData | Profile) => {
  // TODO: replace with your real API call
  await new Promise((r) => setTimeout(r, 700));
  return { ok: true };
};

const mockChangePassword = async (currentPw: string, _newPw: string) => {
  // TODO: replace with your real API call
  await new Promise((r) => setTimeout(r, 700));
...
/** Avatar with camera overlay trigger (no buttons) */
const AvatarPreview: React.FC<{
  ...
  return (
    <div className="flex items-start gap-4">
      <div className="relative group w-28 h-28 rounded-full overflow-hidden background-gray-100 border border-gray-300 cursor-pointer">
        {preview ? (
        ...
        >
          {/* Camera icon svg (kept inline to avoid extra deps) */}
          <svg
